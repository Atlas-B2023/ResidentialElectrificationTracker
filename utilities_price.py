...
class EIADataRetriever:
    ...
    # normalize
    def price_per_btu_converter(self, energy_price_dict: dict) -> dict:
        ...
        match energy_price_dict.get(type):
            ...
            case self.EnergyTypes.ELECTRICITY:
                factor = self.FuelBTUConversion.ELECTRICITY_BTU_PER_KWH
    ...
    def price_df_to_dict(self, eia_df: pl.DataFrame, energy_type: EnergyTypes, state: str) -> dict[str:float]:
        result_dict = {}
    ...
    def monthly_heating_season_heating_oil_price_per_gal(
        ...
        eia_request = requests.get(url, timeout=15)
        eia_request.raise_for_status()
